...
<html>
  <head>
    ...
    <script>
      function changeOpt(n) {
        if (n == 1) {$("#seat_table").removeClass("hidden");}
        else {$("#seat_table").addClass("hidden");}
        if (n == 2) {$("#show_desc").removeClass("hidden");}
        else {$("#show_desc").addClass("hidden");}
        if (n == 3) {$("#reservation").removeClass("hidden");}
        else {$("#reservation").addClass("hidden");}
        if (n == 4) {$("#optional").removeClass("hidden");}
        else {$("#optional").addClass("hidden");}
        if (n == 5) {$("#php_info").removeClass("hidden");}
        else {$("#php_info").addClass("hidden");}
      }
    </script>
<?php
if (empty($_POST['id'])){echo '
<title>로그인</title>
</head>
<body>
  <form id="login" action="./admin.php" method="post">
  <script>
var id = prompt("보안코드를 입력하세요", "");
window.document.write("<input type=\'hidden\' name=\'id\' value=\'"+id+"\'>");
...
<div id="bodyWrap">
  <aside>
    <ul class="category">
      <li class="category_1" onclick="changeOpt(1)">좌석표</li>
      <li class="category_2" onclick="changeOpt(2)">작품소개</li>
      <li class="category_3" onclick="changeOpt(3)">예매현황</li>
      <li class="category_4" onclick="changeOpt(4)">기타설정</li>
      <li class="category_5" onclick="changeOpt(5)">PHP 정보</li>
      <li class="category_6" onclick="location.replace(\'./\')">나가기</li>
    </ul>
  </aside>
  <div id="seat_table" class="setting">
    <p class="sub_title">좌석표 설정</p>
    <br>
...
echo '<label for="hall">복도 위치 (입력한 숫자에 해당하는 행 기준 오른쪽에 복도가 위치하게 됨)</label><br><input id="hall" type="number" min="1" max="50" name="hall" value="'.$hall.'"><br><br>';
echo '<input type="hidden" name="code" value="1000">
      <input type="submit" value="수정하기">
    </form>
    <br><br>
    <p class="sub_title">사용불가석 지정</p>
    <br>
    <form action="./debug.php" method="post">
      <table class="seat_table_opt unusable">';
      for($i = 0; $i < $rows; $j=1){
        $c= chr(++$i+64);
        echo '<tr>';
        for ($j = 1; $j <= $cols; $j++) {
          if (file_exists('./data/seat/unusable/'.$c.$j)) {
            echo '<td class="seat_table_opt"><input type="checkbox" name="'.$c.$j.'" value="'.$c.$j.'" checked=""></td>';
          }
          else {
            echo '<td class="seat_table_opt"><input type="checkbox" name="'.$c.$j.'" value="'.$c.$j.'"></td>';
          }
        }
        echo '</tr>';
      }
echo '</table>
    ...
    <br><br>
    <p class="sub_title">VIP석 지정</p>
    <br>
    <form action="./debug.php" method="post">
      <table class="seat_table_opt vip">';
      for($i = 0; $i < $rows; $j=1){
        $c= chr(++$i+64);
        echo '<tr>';
        for ($j = 1; $j <= $cols; $j++) {
          if (file_exists('./data/seat/unusable/'.$c.$j)) {
            echo '<td class="seat_table_opt"></td>';
          }
          elseif (file_exists('./data/seat/vip/'.$c.$j)) {
            echo '<td class="seat_table_opt"><input type="checkbox" name="'.$c.$j.'" value="'.$c.$j.'" checked=""></td>';
          }
          else {
            echo '<td class="seat_table_opt"><input type="checkbox" name="'.$c.$j.'" value="'.$c.$j.'"></td>';
  ...
  echo '
      ...
      <input type="hidden" name="code" value="1002">
      <br>
      <input type="submit" value="수정하기">
      <br>
      <br>
  ...
  <div id="show_desc" class="setting hidden">
    <p class="sub_title">소개/정보 페이지에 띄울내용 작성하기 (미완성)</p>
  </div>
  <div id="reservation" class="setting hidden">
  <p class="sub_title">예매 현황</p>
  <p>(빨간 박스위에 마우스 커서를 올리면 정보가 나타납니다)</p>
  <br>
  <p class="sub_desc">1부</p>
    ...
    for($i = 0; $i < $rows; $j=1){
      ...
      for ($j = 1; $j <= $cols; $j++) {
        if (file_exists('./data/seat/unusable/'.$c.$j)) {
          ...
          echo '<td title="VIP석" class="vip_cell">vip<br><span>'.$c.$j.'</span></td>';
        }
        else if (file_exists('./data/seat/part_1/'.$c.$j)) {
          $seat_file_id = file('data/seat/part_1/'.$c.$j);
          $seat_id = str_replace(chr(13).chr(10), '',$seat_file_id[0]);
          $seat_file_name = file('data/p_info/'.$seat_id);
          $seat_name = str_replace(chr(13).chr(10), '',$seat_file_name[0]);
          echo '<td title="'.$seat_id.chr(13).chr(10).$seat_name.'" class="booked_cell">'.$c.$j.'</td>';
        }
        else {
          echo '<td class="cell">'.$c.$j.'</td>';
        }
      }
      echo '</tr>';
    }
      ...
      for($i = 0; $i < $rows; $j=1){
        ...
        for ($j = 1; $j <= $cols; $j++) {
          if (file_exists('./data/seat/unusable/'.$c.$j)) {
            ...
            echo '<td class="vip_cell">'.$c.$j.'</td>';
          }
          else if (file_exists('./data/seat/part_2/'.$c.$j)) {
            echo '<td class="booked_cell">'.$c.$j.'</td>';
          }
          else {
            echo '<td class="cell">'.$c.$j.'</td>';
          }
...
echo'</table></div>
  <div id="optional" class="setting hidden">
    <p class="sub_title">기타설정 페이지</p>
  </div>
  <div id="php_info" class="setting hidden">';
echo '<style type="text/css">
  div#php_info {background-color: #fff; color: #222; font-family: sans-serif;}
  div#php_info>pre {margin: 0; font-family: monospace;}
  div#php_info>a:link {color: #009; text-decoration: none; background-color: #fff;}
  div#php_info>a:hover {text-decoration: underline;}
  div#php_info>table {border-collapse: collapse; border: 0; width: 934px; box-shadow: 1px 2px 3px #ccc;}
  div#php_info>.center {text-align: center;}
  div#php_info>.center table {margin: 1em auto; text-align: left;}
  div#php_info>.center th {text-align: center !important;}
  div#php_info>td, th {border: 1px solid #666; font-size: 75%; vertical-align: baseline; padding: 4px 5px;}
  div#php_info>h1 {font-size: 150%;}
  div#php_info>h2 {font-size: 125%;}
  div#php_info>.p {text-align: left;}
  div#php_info>.e {background-color: #ccf; width: 300px; font-weight: bold;}
  div#php_info>.h {background-color: #99c; font-weight: bold;}
  div#php_info>.v {background-color: #ddd; max-width: 300px; overflow-x: auto;}
  div#php_info>.v i {color: #999;}
  div#php_info>img {float: right; border: 0;}
  div#php_info>hr {width: 934px; background-color: #ccc; border: 0; height: 1px;}
  </style>

  <div class="center">
  <table>
  <tbody><tr class="h"><td>
  <a href="http://www.php.net/"><img border="0" src="data:image/png;base64," alt="PHP logo"></a><h1 class="p">PHP Version 5.6.21</h1>
  </td></tr>
  </tbody></table>
  <table>
  <tbody><tr><td class="e">System </td><td class="v">Windows NT HEPHEIR-PC 6.1 build 7600 (Windows 7 Ultimate Edition) i586 </td></tr>
  <tr><td class="e">Build Date </td><td class="v">Apr 27 2016 20:05:18 </td></tr>
  ...
  <tr><td class="e">Loaded Configuration File </td><td class="v">C:\Bitnami\wampstack-5.6.21-2\php\php.ini </td></tr>
  ...
  <tr><td class="e">Server Root </td><td class="v">C:/Bitnami/wampstack-5.6.21-2/apache2 </td></tr>
  <tr><td class="e">Loaded Modules </td><td class="v">core mod_win32 mpm_winnt http_core mod_so mod_access_compat mod_actions mod_alias mod_allowmethods mod_asis mod_auth_basic mod_authn_core mod_authn_file mod_authz_core mod_authz_groupfile mod_authz_host mod_authz_user mod_autoindex mod_cgi mod_deflate mod_dir mod_env mod_filter mod_headers mod_include mod_isapi mod_log_config mod_mime mod_negotiation mod_rewrite mod_setenvif mod_slotmem_shm mod_socache_shmcb mod_ssl mod_version mod_php5 </td></tr>
  </tbody></table>
  <table>
  ...
  <tr><td class="e">OPENSSL_CONF </td><td class="v">C:\Bitnami\wampstack-5.6.21-2/apache2/conf/openssl.cnf </td></tr>
  <tr><td class="e">PATH </td><td class="v">C:\Bitnami\wampstack-5.6.21-2/apache2/bin;C:\Program Files (x86)\NVIDIA Corporation\PhysX\Common;C:\ProgramData\Oracle\Java\javapath;C:\Windows\system32;C:\Windows;C:\Windows\System32\Wbem;C:\Windows\System32\WindowsPowerShell\v1.0\;;;C:\AutoSet8\Server\CUBRID\bin\;;C:\AutoSet8\Server\conf\;C:\AutoSet8\Server\bin\; </td></tr>
  <tr><td class="e">HTTP_HOST </td><td class="v">localhost </td></tr>
  <tr><td class="e">HTTP_CONNECTION </td><td class="v">keep-alive </td></tr>
  <tr><td class="e">CONTENT_LENGTH </td><td class="v">8 </td></tr>
  ...
  <tr><td class="e">HTTP_USER_AGENT </td><td class="v">Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/50.0.2661.102 Safari/537.36 </td></tr>
  <tr><td class="e">CONTENT_TYPE </td><td class="v">application/x-www-form-urlencoded </td></tr>
  <tr><td class="e">HTTP_REFERER </td><td class="v">http://localhost/unit_latest/admin.php </td></tr>
  <tr><td class="e">HTTP_ACCEPT_ENCODING </td><td class="v">gzip, deflate </td></tr>
  <tr><td class="e">HTTP_ACCEPT_LANGUAGE </td><td class="v">ko-KR,ko;q=0.8,en-US;q=0.6,en;q=0.4 </td></tr>
  <tr><td class="e">HTTP_COOKIE </td><td class="v">PHPSESSID=iom11tno7o4i7vpba1i58g83m3 </td></tr>
  ...
  <tr><td class="e">DOCUMENT_ROOT </td><td class="v">C:/Bitnami/wampstack-5.6.21-2/apache2/htdocs </td></tr>
  <tr><td class="e">REQUEST_SCHEME </td><td class="v">http </td></tr>
  <tr><td class="e">CONTEXT_PREFIX </td><td class="v"><i>no value</i> </td></tr>
  <tr><td class="e">CONTEXT_DOCUMENT_ROOT </td><td class="v">C:/Bitnami/wampstack-5.6.21-2/apache2/htdocs </td></tr>
  <tr><td class="e">SERVER_ADMIN </td><td class="v">admin@example.com </td></tr>
  <tr><td class="e">SCRIPT_FILENAME </td><td class="v">C:/Bitnami/wampstack-5.6.21-2/apache2/htdocs/unit_latest/admin.php </td></tr>
  <tr><td class="e">REMOTE_PORT </td><td class="v">3750 </td></tr>
  ...
  <tr><td class="e">REQUEST_URI </td><td class="v">/unit_latest/admin.php </td></tr>
  <tr><td class="e">SCRIPT_NAME </td><td class="v">/unit_latest/admin.php </td></tr>
  </tbody></table>
  <h2>HTTP Headers Information</h2>
  <table>
  <tbody><tr class="h"><th colspan="2">HTTP Request Headers</th></tr>
  <tr><td class="e">HTTP Request </td><td class="v">POST /unit_latest/admin.php HTTP/1.1 </td></tr>
  <tr><td class="e">Host </td><td class="v">localhost </td></tr>
  <tr><td class="e">Connection </td><td class="v">keep-alive </td></tr>
  <tr><td class="e">Content-Length </td><td class="v">8 </td></tr>
  ...
  <tr><td class="e">User-Agent </td><td class="v">Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/50.0.2661.102 Safari/537.36 </td></tr>
  <tr><td class="e">Content-Type </td><td class="v">application/x-www-form-urlencoded </td></tr>
  <tr><td class="e">Referer </td><td class="v">http://localhost/unit_latest/admin.php </td></tr>
  <tr><td class="e">Accept-Encoding </td><td class="v">gzip, deflate </td></tr>
  <tr><td class="e">Accept-Language </td><td class="v">ko-KR,ko;q=0.8,en-US;q=0.6,en;q=0.4 </td></tr>
  <tr><td class="e">Cookie </td><td class="v">PHPSESSID=iom11tno7o4i7vpba1i58g83m3 </td></tr>
  <tr class="h"><th colspan="2">HTTP Response Headers</th></tr>
  <tr><td class="e">X-Powered-By </td><td class="v">PHP/5.6.21 </td></tr>
  ...
  <table>
  <tbody><tr><td class="e">PHP Version </td><td class="v">5.6.21 </td></tr>
  </tbody></table>
  <table>
  <tbody><tr class="h"><th>Directive</th><th>Local Value</th><th>Master Value</th></tr>
  ...
  <tr><td class="e">error_reporting</td><td class="v">-1</td><td class="v">-1</td></tr>
  <tr><td class="e">exit_on_timeout</td><td class="v">Off</td><td class="v">Off</td></tr>
  <tr><td class="e">expose_php</td><td class="v">On</td><td class="v">On</td></tr>
  <tr><td class="e">extension_dir</td><td class="v">C:/Bitnami/wampstack-5.6.21-2/php/ext</td><td class="v">C:/Bitnami/wampstack-5.6.21-2/php/ext</td></tr>
  ...
  <tr><td class="e">include_path</td><td class="v">.;C:/Bitnami/wampstack-5.6.21-2/php/PEAR</td><td class="v">.;C:/Bitnami/wampstack-5.6.21-2/php/PEAR</td></tr>
  ...
  <tr><td class="e">upload_tmp_dir</td><td class="v">C:/Bitnami/WAMPST~1.21-/php/tmp</td><td class="v">C:/Bitnami/WAMPST~1.21-/php/tmp</td></tr>
  ...
  <tr><td class="e">cURL Information </td><td class="v">7.47.1 </td></tr>
  ...
  <tr><td class="e">FreeType Version </td><td class="v">2.6.2 </td></tr>
  ...
  <tr><td class="e">OpenSSL Header Version </td><td class="v">OpenSSL 1.0.1s  1 Mar 2016 </td></tr>
  <tr><td class="e">Openssl default config </td><td class="v">c:/openssl-1.0.2g-win32/ssl/openssl.cnf </td></tr>
  </tbody></table>
  <table>
  <tbody><tr class="h"><th>Directive</th><th>Local Value</th><th>Master Value</th></tr>
  ...
  <tr><td class="e">session.save_path</td><td class="v">C:/Bitnami/WAMPST~1.21-/php/tmp</td><td class="v">C:/Bitnami/WAMPST~1.21-/php/tmp</td></tr>
  ...
  <tr><td class="e">Cache hits </td><td class="v">1 </td></tr>
  <tr><td class="e">Cache misses </td><td class="v">1 </td></tr>
  <tr><td class="e">Used memory </td><td class="v">234368 </td></tr>
  <tr><td class="e">Free memory </td><td class="v">133983360 </td></tr>
  ...
  <tr><td class="e">APR_ICONV_PATH </td><td class="v">C:\AutoSet8\Server\bin\iconv\ </td></tr>
  ...
  <tr><td class="e">COMPUTERNAME </td><td class="v">HEPHEIR-PC </td></tr>
  <tr><td class="e">ComSpec </td><td class="v">C:\Windows\system32\cmd.exe </td></tr>
  <tr><td class="e">CUBRID </td><td class="v">C:\AutoSet8\Server\CUBRID </td></tr>
  <tr><td class="e">CUBRID_DATABASES </td><td class="v">C:\AutoSet8\Server\CUBRID\databases </td></tr>
  <tr><td class="e">CUBRID_LANG </td><td class="v">en_US </td></tr>
  <tr><td class="e">CUBRID_MODE </td><td class="v">client </td></tr>
  ...
  <tr><td class="e">Path </td><td class="v">C:\Program Files (x86)\NVIDIA Corporation\PhysX\Common;C:\ProgramData\Oracle\Java\javapath;C:\Windows\system32;C:\Windows;C:\Windows\System32\Wbem;C:\Windows\System32\WindowsPowerShell\v1.0\;;;C:\AutoSet8\Server\CUBRID\bin\;;C:\AutoSet8\Server\conf\;C:\AutoSet8\Server\bin\; </td></tr>
  <tr><td class="e">PATHEXT </td><td class="v">.COM;.EXE;.BAT;.CMD;.VBS;.VBE;.JS;.JSE;.WSF;.WSH;.MSC </td></tr>
  ...
  <tr><td class="e">PROCESSOR_IDENTIFIER </td><td class="v">Intel64 Family 6 Model 30 Stepping 5, GenuineIntel </td></tr>
  <tr><td class="e">PROCESSOR_LEVEL </td><td class="v">6 </td></tr>
  <tr><td class="e">PROCESSOR_REVISION </td><td class="v">1e05 </td></tr>
  ...
  <tr><td class="e">USERNAME </td><td class="v">HEPHEIR-PC$ </td></tr>
  <tr><td class="e">USERPROFILE </td><td class="v">C:\Windows\system32\config\systemprofile </td></tr>
  <tr><td class="e">windir </td><td class="v">C:\Windows </td></tr>
  <tr><td class="e">AP_PARENT_PID </td><td class="v">7008 </td></tr>
  </tbody></table>
  <h2>PHP Variables</h2>
  <table>
  <tbody><tr class="h"><th>Variable</th><th>Value</th></tr>
  <tr><td class="e">_REQUEST["id"]</td><td class="v">rebye</td></tr>
  <tr><td class="e">_POST["id"]</td><td class="v">rebye</td></tr>
  <tr><td class="e">_COOKIE["PHPSESSID"]</td><td class="v">iom11tno7o4i7vpba1i58g83m3</td></tr>
  <tr><td class="e">_SERVER["OPENSSL_CONF"]</td><td class="v">C:\Bitnami\wampstack-5.6.21-2/apache2/conf/openssl.cnf</td></tr>
  <tr><td class="e">_SERVER["PATH"]</td><td class="v">C:\Bitnami\wampstack-5.6.21-2/apache2/bin;C:\Program Files (x86)\NVIDIA Corporation\PhysX\Common;C:\ProgramData\Oracle\Java\javapath;C:\Windows\system32;C:\Windows;C:\Windows\System32\Wbem;C:\Windows\System32\WindowsPowerShell\v1.0\;;;C:\AutoSet8\Server\CUBRID\bin\;;C:\AutoSet8\Server\conf\;C:\AutoSet8\Server\bin\;</td></tr>
  <tr><td class="e">_SERVER["HTTP_HOST"]</td><td class="v">localhost</td></tr>
  <tr><td class="e">_SERVER["HTTP_CONNECTION"]</td><td class="v">keep-alive</td></tr>
  <tr><td class="e">_SERVER["CONTENT_LENGTH"]</td><td class="v">8</td></tr>
  ...
  <tr><td class="e">_SERVER["HTTP_USER_AGENT"]</td><td class="v">Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/50.0.2661.102 Safari/537.36</td></tr>
  <tr><td class="e">_SERVER["CONTENT_TYPE"]</td><td class="v">application/x-www-form-urlencoded</td></tr>
  <tr><td class="e">_SERVER["HTTP_REFERER"]</td><td class="v">http://localhost/unit_latest/admin.php</td></tr>
  <tr><td class="e">_SERVER["HTTP_ACCEPT_ENCODING"]</td><td class="v">gzip, deflate</td></tr>
  <tr><td class="e">_SERVER["HTTP_ACCEPT_LANGUAGE"]</td><td class="v">ko-KR,ko;q=0.8,en-US;q=0.6,en;q=0.4</td></tr>
  <tr><td class="e">_SERVER["HTTP_COOKIE"]</td><td class="v">PHPSESSID=iom11tno7o4i7vpba1i58g83m3</td></tr>
  ...
  <tr><td class="e">_SERVER["DOCUMENT_ROOT"]</td><td class="v">C:/Bitnami/wampstack-5.6.21-2/apache2/htdocs</td></tr>
  ...
  <tr><td class="e">_SERVER["CONTEXT_DOCUMENT_ROOT"]</td><td class="v">C:/Bitnami/wampstack-5.6.21-2/apache2/htdocs</td></tr>
  <tr><td class="e">_SERVER["SERVER_ADMIN"]</td><td class="v">admin@example.com</td></tr>
  <tr><td class="e">_SERVER["SCRIPT_FILENAME"]</td><td class="v">C:/Bitnami/wampstack-5.6.21-2/apache2/htdocs/unit_latest/admin.php</td></tr>
  <tr><td class="e">_SERVER["REMOTE_PORT"]</td><td class="v">3750</td></tr>
  <tr><td class="e">_SERVER["GATEWAY_INTERFACE"]</td><td class="v">CGI/1.1</td></tr>
  <tr><td class="e">_SERVER["SERVER_PROTOCOL"]</td><td class="v">HTTP/1.1</td></tr>
  <tr><td class="e">_SERVER["REQUEST_METHOD"]</td><td class="v">POST</td></tr>
  <tr><td class="e">_SERVER["QUERY_STRING"]</td><td class="v"><i>no value</i></td></tr>
  <tr><td class="e">_SERVER["REQUEST_URI"]</td><td class="v">/unit_latest/admin.php</td></tr>
  <tr><td class="e">_SERVER["SCRIPT_NAME"]</td><td class="v">/unit_latest/admin.php</td></tr>
  <tr><td class="e">_SERVER["PHP_SELF"]</td><td class="v">/unit_latest/admin.php</td></tr>
  <tr><td class="e">_SERVER["REQUEST_TIME_FLOAT"]</td><td class="v">1464349412.999</td></tr>
  <tr><td class="e">_SERVER["REQUEST_TIME"]</td><td class="v">1464349412</td></tr>
  </tbody></table>
  <hr>
  <h1>PHP Credits</h1>
  <table>
...
<footer>
  <ul class="footer">
    <li><a style="text-decoration: none;background-color: inherit;color:inherit;" href="http://project-unit.tistory.com/" target="_blank">Unit 홈페이지</a></li>
    <li><a style="text-decoration: none;background-color: inherit;color:inherit;" href="http://hepheir.tistory.com/" target="_blank">제작자 홈페이지</a></li>
    <li>문의, 오류 발생시 010-2463-1852 혹은 hepheir@gmail.com 으로 연락주세요</li>
  </ul>
</footer>
</body>
';}
